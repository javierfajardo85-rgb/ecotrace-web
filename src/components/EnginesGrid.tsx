  ...
  return (
    <section
      ...
      className={cn(
        ...
        "relative z-10 -mt-[100dvh] pt-[14dvh] sm:pt-[16dvh] md:z-40 md:-mt-[100vh] md:pt-[20vh] rounded-t-[32px] bg-background text-foreground shadow-[0_-40px_120px_rgba(0,0,0,0.10)]",
        className,
      )}
    >
